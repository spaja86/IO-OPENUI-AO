...
export const gamesCatalog: GameCatalogEntry[] = [
  ...
  },
  {
    ...
    title: 'SPAJA POKER',
    status: 'pilot',
    genre: 'Card strategy / table tournament',
    licensePrice: '15.000 RSD trajna licenca',
    funStartCredit: '0 RSD · training tables',
    professionalStartCredit: '2.400 RSD po START-u',
    summary: 'Skill-based poker format sa jasno odvojenim Fun/Test stolovima, Professional buy-in režimom, anti-collusion kontrolama i audit-ready payout tokovima.',
    compliance: '18+ · ID verifikacija · KYC/AML · responsible play limits · anti-collusion review',
    config: {
      entry_fee_per_player: '2.400 RSD',
      team_size: '6 igrača za standard table window',
      base_prize_pool: '72.000 RSD',
      sponsor_boost: '18.000 RSD weekly tournament reserve',
      bonus_reserve: '12.000 RSD',
      operator_margin_reserve: '6.000 RSD + dispute reserve',
      victory_required_for_bonus: true,
    },
    gamePlan: {
      eligibility: [
        'Aktivna trajna licenca i 18+ verified status',
        'Položen Poker Readiness Gate sa bankroll disciplinom i anti-collusion signalom',
        'Professional mode samo za korisnike sa ID i wallet verifikacijom',
      ],
      matchFormat: 'Table session i weekly tournament prozor sa zaključanim buy-in-om, telemetry praćenjem i finalnim settlement review-em.',
      minimumPlayers: '6 potvrđenih igrača po stolu',
      startFee: '2.400 RSD po igraču pri svakom START-u',
      payouts: [
        { label: 'Collected table entries', value: '14.400 RSD', note: '6 igrača × 2.400 RSD po standard table sesiji.' },
        { label: 'Winner + placement payout pool', value: '72.000 RSD', note: 'Bazni fond za verified turnirski prozor i pozicije.' },
        { label: 'Bonus reserve', value: '12.000 RSD', note: 'Discipline bonus, clean-showdown bonus i final-table streak.' },
      ],
      bonusRules: [
        {
          id: 'clean-showdown-bonus',
          title: 'Clean showdown bonus',
          amount: '3.000 RSD',
          category: 'automatic',
          requiresVictory: true,
          note: 'Važi kada završni showdown nema collusion signal i odluke su u skladu sa prijavljenim bankroll planom.',
        },
        {
          id: 'discipline-ladder-bonus',
          title: 'Bankroll discipline ladder',
          amount: '4.500 RSD',
          category: 'reviewed',
          requiresVictory: true,
          note: 'Dodeljuje se za dosledan sizing i kontrolu rizika kroz ceo prozor bez abuse zastavica.',
        },
        {
          id: 'final-table-chain',
          title: 'Final table chain',
          amount: '4.500 RSD',
          category: 'reviewed',
          requiresVictory: true,
          note: 'Traži tri uzastopna verified final-table rezultata u istom nedeljnom ciklusu.',
        },
      ],
      reviewedMetrics: [
        {
          title: 'Soft-play i chip-dumping audit',
          description: 'Sumnjive razmene čipova, pasivno dogovaranje i neprirodni fold obrasci automatski šalju payout u hold.',
          payoutMode: 'manual-review',
        },
        {
          title: 'Table-collusion network review',
          description: 'Ponavljani zatvoreni krug igrača i koordinisano targetiranje jednog naloga aktiviraju ručni pregled.',
          payoutMode: 'manual-review',
        },
        {
          title: 'Telemetry integrity score',
          description: 'Hand history, timing i action sequence moraju imati konzistentan trag pre prelaska iz review u verified status.',
          payoutMode: 'manual-review',
        },
      ],
    },
  },
  {
    ...
    professionalStartCredit: '1.600 RSD po START-u',
    summary: 'Program uvodi centralni Gejming endžin, jasnu granicu Fun/Test i Professional režima i SPAJAPRO orkestraciju kompatibilnosti.',
    compliance: '18+ za Professional · ID verifikacija · KYC/AML · telemetry + audit log',
    config: {
    ...
    gamePlan: {
      eligibility: [
        'Aktivna trajna licenca za Professional režim',
        'Položen Gejming endžin readiness gate sa modulskom kompatibilnošću',
        'Professional mode samo za 18+ korisnike sa ID i wallet verifikacijom',
      ],
      matchFormat: 'Modularni meč sa zaključanim profilom endžina, modul mapom i audit tragom po sesiji.',
      minimumPlayers: '1 potvrđen igrač (do 4 u timskom modu)',
      ...
      bonusRules: [
        ...
        {
          id: 'qa-proof-bonus',
          title: 'QA proof bonus',
          amount: '5.000 RSD',
          category: 'reviewed',
          requiresVictory: true,
          note: 'Dodeljuje se kada su odgovori na vizuelna i logička pitanja konzistentni sa gameplay tragom.',
        },
        {
          id: 'spajapro-orchestration',
          title: 'SPAJAPRO orchestration bonus',
          amount: '5.000 RSD',
          category: 'reviewed',
          requiresVictory: true,
          note: 'Traži stabilan orchestration tok bez fallback eskalacije.',
        },
      ],
      reviewedMetrics: [
        {
        ...
        {
          title: 'ChatGPT link audit',
          description: 'Svaki korišćeni ChatGPT link mora imati validiranu namenu: edukacija, level dizajn ili QA provera.',
          payoutMode: 'manual-review',
        },
        {
          title: 'SPAJAPRO fallback integrity',
          description: 'Ako se aktivira fallback, sistem proverava da li su pravila kompatibilnosti ostala netaknuta.',
          payoutMode: 'manual-review',
        },
      ],
    },
  ...
  {
    id: 'transformes-1350',
    title: 'TRANSFORMES 1350',
    status: 'pilot',
    genre: 'Transformation tactics / squad arena',
    licensePrice: '13.500 RSD trajna licenca',
    funStartCredit: '0 RSD · academy simulation',
    professionalStartCredit: '1.350 RSD po START-u',
    summary: 'Transformacioni squad format za igrače koji prolaze 1350 readiness gate, sa manjim START ulazom, disciplinom forme i audit-ready payout pravilima.',
    compliance: '18+ · 1350 readiness gate · ID verifikacija · KYC/AML · replay + anti-collusion review',
    config: {
      entry_fee_per_player: '1.350 RSD',
      team_size: '4 vs 4',
      base_prize_pool: '54.000 RSD',
      sponsor_boost: '18.000 RSD academy reserve',
      bonus_reserve: '13.500 RSD',
      operator_margin_reserve: '4.500 RSD + review reserve',
      victory_required_for_bonus: true,
    },
    gamePlan: {
      eligibility: [
        'Aktivna trajna licenca i 18+ verified status',
        'Položen 1350 readiness gate kroz tri transform discipline provere i replay review',
        'Minimum dve stabilne forme po igraču i čist anti-abuse signal u poslednjem ciklusu',
      ],
      matchFormat: '4v4 squad arena meč sa zaključanim transform slotovima, readiness score pragom i weekly reevaluation ciklusom.',
      minimumPlayers: '8 potvrđenih igrača',
      startFee: '1.350 RSD po igraču pri svakom START-u',
      payouts: [
        {
          label: 'Collected entry fees',
          value: '10.800 RSD',
          note: '8 igrača × 1.350 RSD',
        },
        {
          label: 'Winner academy payout',
          value: '54.000 RSD',
          note: 'Bazni fond za verified squad pobedu u TRANSFORMES 1350 prozoru.',
        },
        {
          label: 'Bonus reserve',
          value: '13.500 RSD',
          note: 'Form discipline, clean objective chain i commander-call validacija samo uz pobedu.',
        },
      ],
      bonusRules: [
        {
          id: 'commander-chain',
          title: 'Commander chain bonus',
          amount: '4.500 RSD',
          category: 'reviewed',
          requiresVictory: true,
          note: 'Traži tri uzastopna squad poteza koji prate prijavljeni transform plan bez haotičnog prebacivanja formi.',
        },
        {
          id: 'clean-form-rotation',
          title: 'Clean form rotation',
          amount: '3.000 RSD',
          category: 'automatic',
          requiresVictory: true,
          note: 'Validira se kroz uredan prelaz attack → mobility → control bez izgubljenog objective tempa.',
        },
        {
          id: 'discipline-core-bonus',
          title: 'Discipline core bonus',
          amount: '6.000 RSD',
          category: 'reviewed',
          requiresVictory: true,
          note: 'Dodeljuje se kada ceo tim ostane u prijavljenim transform ulogama i replay potvrdi urednu koordinaciju.',
        },
      ],
      reviewedMetrics: [
        {
          title: '1350 readiness replay review',
          description: 'Sistem proverava da li gameplay zaista odgovara 1350 readiness band-u kroz tempo promene formi, zonu kontrole i objective završnicu.',
          payoutMode: 'manual-review',
        },
        {
          title: 'Commander communications audit',
          description: 'Bonus i status ostaju pending ako tim prijavi commander-chain, a replay ili telemetry ne pokažu dosledno izvršenje plana.',
          payoutMode: 'manual-review',
        },
        {
          title: 'Anti-collusion ladder control',
          description: 'Ponavljani laki protivnici, čudni surrender obrasci ili nerealno sinhrono prebacivanje formi aktiviraju ručni hold.',
          payoutMode: 'manual-review',
        },
      ],
    },
...
export const globalGamesGlossary: GlossaryEntry[] = [
  ...
  { term: 'Gejming endžin', category: 'Arhitektura', definition: 'Centralni sloj koji standardizuje pravila meča, module i kompatibilnost između podsistema.' },
  { term: 'SPAJAPRO orchestrator', category: 'Operacije', definition: 'Operativni okvir koji vodi lifecycle sesije, proverava kompatibilnost i aktivira fallback kada je potreban.' },
  { term: 'ChatGPT link sloj', category: 'Knowledge', definition: 'Skup validiranih referenci za edukaciju, dizajn nivoa i QA pitanja, uz obavezan audit trag.' },
  { term: 'Self-compatibility', category: 'Integritet', definition: 'Pravilo da igra zadržava identitet, ulaz/izlaz formate i ista očekivanja ponašanja kroz sve module.' },
];
...
export const gamesEncyclopedia: Record<string, GameKnowledgeEntry> = {
  ...
  'spaja-poker': {
    shortOverview: [
      'SPAJA POKER je profesionalni table format koji tretira poker kao skill competition kroz odlučivanje, discipline sizing i dugoročnu stabilnost.',
      'Fun/Test stolovi služe za vežbu bez novca, dok Professional režim uvodi licencu, buy-in START, payout review i anti-abuse pravila.',
      'Osnovni fokus je kvalitet odluka kroz više rundi i transparentan audit trag od prvog poteza do finalne isplate.',
    ],
    expandedOverview: [
      'Professional sesije su organizovane kroz standard table window (6 igrača) i nedeljne turnirske prozore sa unapred definisanim fondom i bonus rezervom.',
      'Svaka runda beleži hand događaje, pozicije, sizing obrazac, showdown tok i transakcione tačke koje ulaze u telemetry i settlement pipeline.',
      'Payout je višefazan: pending → review → verified → paid, a svaki prelaz statusa ima dokazive kriterijume i audit zapis.',
    ],
    expertView: [
      'Ekspertni nivo se vidi kroz kontrolu rizika, planiranje stack dubine, adaptaciju protiv različitih table profila i disciplinu kada momentum padne.',
      'Najjači igrači ne jure svaki pot; biraju prozore sa najboljim expected value odnosom i čuvaju reputacioni integritet sesije.',
      'U Professional zoni i dobra igra može završiti u review hold-u ako action pattern izgleda kao soft-play, chip-dumping ili koordinisana tabela.',
    ],
    operationalView: [
      'Professional pristup traži 18+, identitet, KYC/AML, aktivnu licencu i prolaz kroz Poker Readiness Gate pre prvog real-money stola.',
      'Svaki meč ima zaključan buy-in, fazni payout status, dispute prozor i obavezan PDF/ledger trag za sve finansijske promene.',
      'Fraud signal arhitektura prati multi-account veze, koordinisane stolove, nelogične transfer obrasce i sumnjive timing sekvence.',
    ],
    historyMetaScenarios: [
      'Rana faza uči pozicionu disciplinu i kontrolu impulsa, srednja faza gradi stabilan sizing model, a završna faza testira odluke pod pritiskom finalnog stola.',
      'Meta se menja kroz agresivne i kontrolne trendove, ali platforma favorizuje stabilne odluke i čist telemetry trag umesto varijanse bez pokrića.',
      'Najvredniji ishod nije samo jednokratna pobeda već kontinuitet clean sesija bez dispute-a i bez anti-collusion zastavica.',
    ],
    masterProfile: {
      identity: 'SPAJA POKER',
      genre: 'Card strategy / competitive table',
      subgenre: 'Skill-based table window i weekly tournament ladder',
      coreIdea: 'Igrač donosi seriju odluka kroz poziciju, sizing i read protivnika, a sistem meri kvalitet i integritet svake sesije pre finansijskog zaključavanja.',
      matchGoal: 'Kroz disciplinovanu igru završiti u payout zoni i potvrditi rezultat bez anti-abuse signala.',
      victoryCondition: 'Verified placement ili pobeda uz čist hand history, zatvoren dispute prozor i status prebačen u paid.',
      audience: 'Igrači koji žele taktičku igru odluka, kontrolu rizika i transparentna Professional pravila.',
      sessionLength: '25 do 70 minuta po table/tournament prozoru.',
      entryDifficulty: 'Nizak ulaz u Fun/Test, srednje-visok prag za stabilan Professional rezultat.',
      tacticalDepth: 'Visoka; pozicija, tempo, sizing i psihološka disciplina zajedno odlučuju ishod.',
      playFormat: '1v1v1v1v1v1 table format sa turnirskim prozorima i rang evaluacijom.',
      funTestUse: 'Bezbedan trening preflop/postflop odluka, bankroll osnova i čitanje tabela bez finansijskog rizika.',
      professionalUse: 'Licencirani real-money format sa buy-in pravilima, payout pipeline-om i anti-collusion governance slojem.',
    },
    mechanics: [
      {
        title: 'Osnovni tok partije',
        points: [
          'Stol kreće zaključanim buy-in-om, registracijom igrača i telemetry inicijalizacijom hand događaja.',
          'Svaka hand sekvenca prati poziciju, akcije, sizing i showdown rezultat sa povezanim operativnim ID-jem.',
          'Session close aktivira payout procenu i statusnu tranziciju kroz pending, review, verified i paid fazu.',
        ],
      },
      {
        title: 'Fun/Test naspram Professional režima',
        points: [
          'Fun/Test nema real-money tok i služi za obuku odlučivanja, discipline i pravila.',
          'Professional uvodi licencu, buy-in, compliance obaveze i obavezni anti-collusion nadzor.',
          'Prelaz je dozvoljen tek kada igrač dokaže stabilnost u readiness ciklusu.',
        ],
      },
      {
        title: 'Payout i hold logika',
        points: [
          'Po završetku meča rezultat ulazi u pending i čeka automatske provere.',
          'Ako postoji rizik signal, status ide u review hold i payout ostaje zaključan.',
          'Tek verified ishod može preći u paid sa PDF potvrdom i ledger evidencijom.',
        ],
      },
      {
        title: 'Abuse obrasci koje sistem prati',
        points: [
          'Soft-play i koordinisani fold obrasci između povezanih naloga.',
          'Chip-dumping i nelogične razmene vrednosti koje odstupaju od regularne strategije.',
          'Multi-account prisustvo i ponavljani zatvoreni krug stolova.',
        ],
      },
    ],
    everythingInGame: [
      {
        title: 'Table arhitektura',
        points: [
          'Standardni prozor koristi 6 igrača sa jasno definisanim buy-in pragom i payout zonama.',
          'Weekly turniri proširuju fond i uvode final-table bonus kriterijume.',
        ],
      },
      {
        title: 'Ekonomija',
        points: [
          'Trajna licenca otključava Professional poker sloj i njegov settlement model.',
          'START buy-in aktivira session i ulazi u rezervisana sredstva dok review ne bude zatvoren.',
        ],
      },
      {
        title: 'Signal i audit sistem',
        points: [
          'Hand history i action timing služe kao dokaz igre i osnova za review odluke.',
          'Svaka moderatorska i finansijska intervencija ima razlog, identifikator i vreme izmene.',
        ],
      },
    ],
    tacticalGuide: [
      { title: 'Opening taktike', focus: 'Pozicija i selekcija ruku', points: ['Početak sesije gradi range disciplinu, ne brz profit.', 'Rani impulsi često aktiviraju loš risk profil za ostatak stola.'] },
      { title: 'Mid-game taktike', focus: 'Stack i sizing kontrola', points: ['Prati odnos rizika i equity prozora pre velikih commit odluka.', 'Stabilan sizing model je jači od nasumičnih hero poteza.'] },
      { title: 'End-game taktike', focus: 'Final table odluke', points: ['U završnici je važniji survival i kvalitet odluke nego brz all-in odgovor.', 'Ne otvaraj varijansu bez plana jer review model vrednuje konzistentnost.'] },
      { title: 'Agresivni stil', focus: 'Pritisak', points: ['Efikasan je kad igrač ima read i kontrolu stack dubine.', 'Bez discipline prelazi u signal koji liči na dump ili dogovoreni trade.'] },
      { title: 'Defanzivni stil', focus: 'Kontrola rizika', points: ['Koristan je za očuvanje kapitala i stabilan ulazak u payout zonu.', 'Preterana pasivnost gubi value i spušta konačni rezultat.'] },
      { title: 'Kontrolni stil', focus: 'Tempo i informacija', points: ['Ujednačen ritam akcija smanjuje greške i panic odluke.', 'Posebno je važan kada stol ima mešane profile agresije.'] },
    ],
    explainedTopics: [
      { title: 'Pending → review → verified → paid', what: 'Statusni tok svake Professional poker isplate.', why: 'Odvaja preliminarni rezultat od regulatorno i operativno potvrđene isplate.', whenToUse: 'Automatski po zatvaranju svakog table/tournament prozora.', whenNotToUse: 'Ne sme se preskakati nijedna faza kada postoji fraud ili dispute signal.', whatItBrings: 'Jasan i fer settlement proces sa tragom odluka.', cost: 'Može produžiti vreme isplate za rizične sesije.', misuseConsequence: 'Prebrza isplata ruši integritet i može legalno ugroziti platformu.', impact: 'Direktno utiče na poverenje, finansijsku sigurnost i regulatornu usklađenost.' },
      { title: 'Soft-play i chip-dumping signal', what: 'Model detekcije koordinisanih poteza i neprirodnih transfera vrednosti.', why: 'Štiti profesionalni fond od nameštanja i lažnih pobeda.', whenToUse: 'Na svim Professional stolovima, posebno u final-table i high-payout prozorima.', whenNotToUse: 'Ne donosi se presuda bez konteksta hand istorije i višerundne analize.', whatItBrings: 'Smanjuje zloupotrebe i stabilizuje rang i payout sistem.', cost: 'Traži dodatni review kapacitet i može povećati hold slučajeve.', misuseConsequence: 'Pogrešan signal može blokirati legitimne igrače.', impact: 'Određuje ko zadržava Professional status i pravo na isplatu.' },
      { title: 'Bankroll disciplina', what: 'Dosledno upravljanje buy-in rizikom i veličinom poteza kroz sesiju.', why: 'Sprečava impulsivne obrasce koji vode finansijskom i reputacionom padu.', whenToUse: 'Kao osnovni okvir svake Professional partije i turnirskog ciklusa.', whenNotToUse: 'Ne treba ga mešati sa pasivnom igrom bez value planiranja.', whatItBrings: 'Veću stabilnost rezultata i bolji readiness signal.', cost: 'Traži strpljenje i odricanje od kratkoročnih rizičnih poteza.', misuseConsequence: 'Loša disciplina vodi čestim hold-ovima i gubitku statusa.', impact: 'Utiče na dugoročnu održivost igrača i ekonomije sistema.' },
    ],
    economyBreakdown: [
      { title: 'Trajna licenca', value: '15.000 RSD', detail: 'Otključava SPAJA POKER Professional sloj i sve compliance tokove.' },
      { title: 'START buy-in', value: '2.400 RSD po igraču', detail: 'Aktivira ulaz u verified table session i zaključava sredstva do validacije.' },
      { title: 'Ulazni trošak stola', value: '14.400 RSD po standard sesiji', detail: '6 igrača × 2.400 RSD uz obavezni audit context ID.' },
      { title: 'Bazni payout fond', value: '72.000 RSD', detail: 'Raspodela po plasmanu u skladu sa turnirskim pravilima.' },
      { title: 'Bonus rezerva', value: '12.000 RSD', detail: 'Clean showdown, discipline ladder i final-table chain bonusi.' },
      { title: 'Operator + dispute rezerva', value: '6.000 RSD', detail: 'Pokriraju review, moderation i dispute procese.' },
      { title: 'Payout faze', value: 'pending → review → verified → paid', detail: 'Svaki status mora imati telemetry i audit potvrdu.' },
      { title: 'Penali', value: 'Hold, umanjenje, suspenzija', detail: 'Soft-play, chip-dumping, multi-account i koordinisane tabele nose striktne sankcije.' },
      { title: 'Primer obračuna', value: '2.400 START → verified placement payout + bonus', detail: 'Samo uz čist signal, zatvoren dispute i odobren settlement.' },
    ],
    scenarios: [
      { title: 'Session od prijave do isplate', summary: 'Licenca, buy-in, igra, review i finalni payout.', steps: ['Aktivna licenca i eligibility check', 'START rezervacija buy-in-a', 'Table session i telemetry zapis', 'Pending status', 'Review ili direktna verifikacija', 'Paid + PDF potvrda'] },
      { title: 'Pobeda bez bonusa', summary: 'Stabilan rezultat bez specijalnih bonus uslova.', steps: ['Kontrolisana igra', 'Čist hand history', 'Verified placement', 'Standardna isplata'] },
      { title: 'Pobeda sa bonusom', summary: 'Ispunjeni discipline i clean-showdown uslovi.', steps: ['Stabilan bankroll plan', 'Final table ulaz', 'Clean showdown signal', 'Bonus review', 'Verified bonus payout'] },
      { title: 'Sporni sto', summary: 'Sumnja na koordinisanu igru.', steps: ['Fraud trigger aktiviran', 'Payout hold', 'Manual review hand sekvenci', 'Odluka: verified ili sanction'] },
      { title: 'Diskvalifikacija i suspenzija', summary: 'Potvrđen abuse obrazac.', steps: ['Detektovan chip-dumping ili multi-account', 'Rezultat poništen', 'Sredstva zamrznuta', 'Status suspendovan'] },
      { title: 'Prelazak iz Fun/Test u Professional', summary: 'Igrač prelazi iz treninga u real-money režim kroz readiness gate.', steps: ['Trening stolovi bez novca', 'Poker Readiness Gate', '18+ i KYC/AML verifikacija', 'Prvi low-risk Professional sto', 'Ulazak u weekly ladder'] },
    ],
    metaDevelopment: [
      { title: 'Trenutno najjače', detail: 'Igrači sa stabilnim sizing disciplinom i čistim timing profilom drže najviši verified rezultat.' },
      { title: 'Stabilno za početnike', detail: 'Konzervativniji range izbor i stroga kontrola buy-in rizika daju najviše čistih sesija.' },
      { title: 'Visok skill prag', detail: 'Final table konzistentnost bez hold-ova i bez anti-collusion zastavica.' },
      { title: 'Šta menja balans', detail: 'Promene blind strukture i payout modela direktno pomeraju optimalni tempo odluka.' },
      { title: 'Uticaj update-a na ekonomiju', detail: 'Svaka izmena review praga menja broj hold-ova, prosečno vreme isplate i odnos rizika/fonda.' },
    ],
    learningPath: [
      { level: 'Početnik', mustUnderstand: ['Osnove pozicije i selekcije ruku', 'Razliku između Fun/Test i Professional režima'], mustPractice: ['Kontrolu impulsa', 'Osnovni bankroll okvir'], eliminateMistakes: ['All-in bez plana', 'Ignorisanje pozicije'] },
      { level: 'Srednji nivo', mustUnderstand: ['Sizing disciplinu', 'Kako čitati table dinamiku bez preteranog rizika'], mustPractice: ['Ujednačen tempo odluka', 'Praćenje sopstvenog risk profila'], eliminateMistakes: ['Nasumični bluff', 'Preterana pasivnost'] },
      { level: 'Napredni nivo', mustUnderstand: ['Final table prilagođavanje', 'Kako anti-collusion model tumači obrasce igre'], mustPractice: ['Konzistentne sesije kroz više stolova', 'Kontrolisanu agresiju'], eliminateMistakes: ['Soft-play signale', 'Nelogične transfer obrasce'] },
      { level: 'Profesionalni nivo', mustUnderstand: ['Payout pipeline, dispute tok i compliance obaveze', 'Telemetry signal arhitekturu i kriterijume za verified status'], mustPractice: ['Stabilan profit uz čist audit trag', 'Nedeljnu reevaluaciju readiness statusa'], eliminateMistakes: ['Multi-account veze', 'Chip-dumping', 'Ponavljane review hold-ove'] },
    ],
    glossary: [
      { term: 'Table window', category: 'Format', definition: 'Vremenski i strukturni okvir jedne Professional poker sesije sa 6 igrača.' },
      { term: 'Buy-in START', category: 'Finansije', definition: 'Obavezni ulazni iznos koji aktivira sesiju i prelazi u rezervisana sredstva.' },
      { term: 'Payout hold', category: 'Finansije', definition: 'Privremeno zamrzavanje isplate dok review ne zatvori rizične signale.' },
      { term: 'Soft-play', category: 'Anti-fraud', definition: 'Namerno neagresivna ili koordinisana igra između povezanih igrača.' },
      { term: 'Chip-dumping', category: 'Anti-fraud', definition: 'Veštačko prelivanje čipova ka ciljnom nalogu mimo legitimne strategije.' },
      { term: 'Readiness Gate', category: 'Access', definition: 'Kvalifikacioni okvir koji proverava da je igrač spreman za Professional režim.' },
      { term: 'Dispute window', category: 'Admin', definition: 'Period tokom kog igrač može osporiti rezultat ili review odluku.' },
    ],
    faq: [
      { question: 'Šta je SPAJA POKER?', answer: 'Skill-based Professional poker format sa jasnim pravilima, audit tragom i anti-collusion kontrolama.' },
      { question: 'Da li mogu odmah igrati za novac?', answer: 'Ne; prvo moraš proći readiness gate, 18+ proveru, identitet i KYC/AML validaciju.' },
      { question: 'Kako funkcioniše isplata?', answer: 'Rezultat ide kroz pending, zatim review po potrebi, pa verified i tek tada paid status.' },
      { question: 'Zašto je payout zamrznut?', answer: 'Najčešće zbog soft-play, chip-dumping, multi-account ili timing anomalija koje traže ručni audit.' },
      { question: 'Kako prelazim iz Fun/Test u Professional?', answer: 'Trening stolovi bez novca, pa uspešan readiness ciklus i potpuna verifikacija naloga.' },
    ],
    trust: [
      { title: 'Provera rezultata', detail: 'Ne vrednuje se samo krajnji plasman već i integritet hand istorije i odluka.' },
      { title: 'Žalbe i sporovi', detail: 'Svaki review hold ima dispute putanju sa dokumentovanim zaključkom.' },
      { title: 'Detekcija abuse-a', detail: 'Sistem aktivno prati soft-play, chip-dumping, multi-account i koordinisane table mreže.' },
      { title: 'Audit trag', detail: 'Svaka finansijska ili moderatorska promena mora imati razlog, vreme i identifikator.' },
      { title: 'Kontinuirana kompetentnost', detail: 'Professional status ostaje aktivan samo uz stabilne rezultate i čist signal kroz nedeljne cikluse.' },
    ],
    relatedSections: [
      { label: 'Game Plan', anchor: 'game-plan', note: 'Buy-in model, fond i bonus pravila.' },
      { label: 'Knowledge Gate', anchor: 'knowledge-gate', note: 'Readiness pragovi i nedeljna evaluacija.' },
      { label: 'Wallet / Ledger', anchor: 'wallet-ledger', note: 'Rezervacije, hold statusi i settlement.' },
      { label: 'Lifecycle', anchor: 'match-lifecycle', note: 'Tok od prijave do paid statusa.' },
      { label: 'Compliance', anchor: 'compliance-controls', note: '18+, KYC/AML, dispute i anti-abuse pravila.' },
      { label: 'Bounty', anchor: 'bounty-program', note: 'Weekly ladder i final-table dodatni incentivi.' },
      { label: 'Playground', anchor: 'fun-test-playground', note: 'Trening stolovi bez finansijskog rizika.' },
    ],
    continuousTestingGate: {
      title: 'SPAJA POKER Continuous Readiness Gate',
      summary: 'Ulazak i ostanak u Professional poker modu zavise od stalne procene kvaliteta odluka, bankroll discipline i anti-collusion integriteta kroz nedeljne cikluse.',
      goals: [
        'Filter mora odvojiti kratkoročnu sreću od dokazive kompetentnosti i stabilnosti.',
        'Professional pristup ostaje privilegija sa jasnim finansijskim i reputacionim odgovornostima.',
        'Fun/Test ostaje mesto za učenje, dok Professional zahteva dokaz kroz ponovljive rezultate.',
      ],
      qualificationMetrics: [
        { title: 'Readiness tests', value: '3 ciklusa', detail: 'Kandidat prolazi tri odvojena evaluaciona ciklusa odluka i discipline.' },
        { title: 'Decision stability threshold', value: '>= 82%', detail: 'Minimum prag doslednih odluka kroz različite table profile.' },
        { title: 'Bankroll discipline score', value: '>= 80%', detail: 'Smanjen impulsni rizik i kontrolisan sizing kroz ceo prozor.' },
        { title: 'Anti-collusion baseline', value: '0 critical flags', detail: 'Kritični soft-play/chip-dumping signali automatski ruše pristup.' },
        { title: 'Retention check', value: 'Nedeljno', detail: 'Status se održava samo uz kontinuirano prolazne rezultate.' },
      ],
      knowledgeCategories: [
        { title: 'Table strategija', points: ['Pozicija, range disciplina i tempo donošenja odluka.', 'Razlikovanje value odluka od impulsa i varijanse.'] },
        { title: 'Bankroll i rizik', points: ['Kontrola buy-in izloženosti i granica rizika po sesiji.', 'Stabilnost kroz više sesija je važnija od jednog skoka.'] },
        { title: 'Compliance i odgovorno igranje', points: ['18+, identitet, KYC/AML i dispute proces su obavezni deo Professional režima.', 'Kršenje limita i pravila vodi u downgrade ili suspenziju.'] },
        { title: 'Fraud i integritet', points: ['Prepoznavanje soft-play, chip-dumping i coordinated table obrazaca.', 'Razumevanje da svaka anomalija utiče na payout i status.'] },
      ],
      visualQuestionRules: [
        'Vizuelni zadaci koriste hand prikaze, betting sekvence i table mape za procenu odluka.',
        'Kandidat mora objasniti izbor poteza kroz rizik/reward kontekst, ne samo krajnji rezultat.',
        'Scenario varijacije se rotiraju da bi se sprečilo mehaničko pamćenje odgovora.',
      ],
      weeklyCycle: [
        { title: 'Ponedeljak', summary: 'Otvaranje ciklusa i postavljanje pragova.', steps: ['Ažuriranje risk limita', 'Objava fokus scenarija', 'Reset watchlist signala'] },
        { title: 'Utorak–sreda', summary: 'Standardne readiness sesije.', steps: ['Table evaluacije', 'Merenje decision stability', 'Praćenje bankroll discipline'] },
        { title: 'Četvrtak', summary: 'Fraud signal analiza.', steps: ['Mreža povezanih naloga', 'Detekcija coordinated table obrazaca', 'Privremeni hold spornih naloga'] },
        { title: 'Petak', summary: 'Professional tournament window.', steps: ['Final-table test', 'Payout pre-scoring', 'Anomaly flag prioriteti'] },
        { title: 'Subota', summary: 'Manual review i korekcije.', steps: ['Ručni pregled spornih hand-ova', 'Korekcija statusa', 'Ažuriranje retention odluka'] },
        { title: 'Nedelja', summary: 'Settlement i go/no-go evaluacija.', steps: ['Zaključavanje nedelje', 'SLA pregled sporova', 'Objava statusa za sledeći ciklus'] },
      ],
      retentionRules: [
        'Pad ispod readiness praga u dva uzastopna ciklusa vraća igrača u Fun/Test ili low-risk režim.',
        'Svaki critical anti-collusion signal automatski suspenduje Professional isplate do konačne odluke.',
        'Ponovni ulazak nakon suspenzije zahteva nov čist kvalifikacioni ciklus.',
      ],
      antiAbuseRules: [
        'Soft-play, chip-dumping i coordinated table obrasci pokreću trenutni review hold.',
        'Multi-account povezivanje u istom prozoru automatski blokira bonus i progression priznanje.',
        'Ponavljani match-krugovi sa istim grupama igrača imaju cooldown pre novih payout priznanja.',
        'Tokom aktivnog review-a nalog ne može preći u verified payout status.',
      ],
      userJourney: [
        'Korisnik kreće od Fun/Test stolova i gradi disciplinu bez finansijskog rizika.',
        'Nakon readiness ciklusa prelazi u low-risk Professional table window.',
        'Ako održava stabilnost i čist signal, ulazi u weekly tournament i bonus zonu.',
        'Ako padne ispod retention praga, vraća se u trening ili dobija privremenu suspenziju.',
      ],
      successMetrics: [
        'Conversion stopa iz Fun/Test u Professional sa održanim statusom.',
        'Procenat clean sesija bez dispute-a i bez manual hold-a.',
        'Broj fraud trigger-a na 1.000 poker sesija.',
        'Median vreme od pending do paid statusa.',
        'Stopa sporova rešenih unutar definisanog SLA roka.',
      ],
      rolloutPhases: [
        'Faza 1: pilot cohort sa ograničenim brojem verified igrača.',
        'Faza 2: controlled scale uz dnevne i nedeljne limite i pojačan manual review.',
        'Faza 3: full rollout sa automatskim kontrolama i stabilnim KPI pragovima.',
        'Faza 4: optimizacija fraud modela ka nižem false-positive nivou.',
        'Faza 5: proširenje turnirskih prozora uz očuvanje ekonomskog balansa.',
      ],
    },
  },
  'transformes-1350': {
    shortOverview: [
      'TRANSFORMES 1350 je prelazni profesionalni 4v4 squad sloj za igrače koji mogu da dokažu disciplinu transformacije, komunikaciju i stabilan objective tempo.',
      'Fun/Test ostaje academy simulation zona za učenje formi, dok Professional otključava manji START, jasne readiness pragove i review-podoban weekly ladder.',
      'Broj 1350 predstavlja readiness band: kombinaciju decision signala, širine formi i kvaliteta odluka pod pritiskom.',
    ],
    expandedOverview: [
      'Program deli napredak na trening, qualification gate i verified ladder mečeve sa manjim finansijskim rizikom od višeg competitive sloja.',
      'Svaki igrač mora da pokaže da razume najmanje dve stabilne forme, timing prebacivanja i osnovnu commander-call poslušnost.',
      'Ekonomija meča je manja, ali je review disciplina stroža jer TRANSFORMES 1350 služi kao filter između čistog treninga i većeg profesionalnog fonda.',
    ],
    expertView: [
      'Ekspertni kvalitet ne meri samo mehaniku već i da li tim pretvara dobru transform rotaciju u čist objective lanac bez haotičnog rasipanja cooldown-a.',
      'Najveća greška igrača oko 1350 readiness nivoa je prerano prebacivanje u agresivnu formu bez zone kontrole, escape plana i podrške tima.',
      'Najveći signal napretka je kada tim zna da uspori, resetuje formacije i pretvori mali dobitak u siguran capture ili power-core zaključavanje.',
    ],
    operationalView: [
      'Professional sesija traži aktivnu licencu, 18+ verifikaciju, readiness score iznad 1350 i weekly potvrdu da nisu pali ključni skill ili fair-play indikatori.',
      'Svaki meč čuva replay, commander-call oznake, transform role deklaracije i payout stanje kako bi prelaz ka višem competitive programu ostao audit-ready.',
      'TRANSFORMES 1350 funkcioniše kao akademski competitive filter: dovoljno ozbiljan za novac, ali i dalje fokusiran na dokazivanje kontinuiteta, ne samo jedne dobre partije.',
    ],
    historyMetaScenarios: [
      'Mnogi timovi na ovom nivou gube jer pokušavaju da igraju kao top-tier burst sastavi bez stabilne rotacije formi i bez discipline u držanju zona.',
      'Meta promena najviše pogađa forme koje pojednostavljuju engage, disengage i objective zaključavanje, jer one direktno utiču na readiness prolaznost.',
      'Najvredniji razvojni scenario je prelazak sa individualno zanimljivih transformacija na četvorku koja zna da pretvori tempo i pozicioniranje u uredan objective ritam.',
    ],
    masterProfile: {
      identity: 'TRANSFORMES 1350',
      genre: 'Transformation tactics',
      subgenre: '4v4 academy ladder skill competition',
      coreIdea: 'Tim od četiri igrača mora da dokaže da može stabilno, čisto i disciplinovano da koristi transform forme u 1350 readiness band-u.',
      matchGoal: 'Pobediti protivnički tim kroz čist transform plan, kontrolu zone, objective lanac i verified review ishod.',
      victoryCondition: 'Pad protivničkog core-a uz potvrdu readiness discipline, clean replay i zatvoren dispute prozor.',
      audience: 'Igrači i timovi koji žele prelaz sa academy simulacije na manji profesionalni ladder uz jasan skill prag.',
      sessionLength: '18 do 32 minuta po academy ladder meču.',
      entryDifficulty: 'Srednje visoka; traži stabilne osnove, više formi i disciplinu u komunikaciji.',
      tacticalDepth: 'Vrlo visoka; svaka greška u tajmingu forme, zoni i ulozi brzo ruši readiness sliku tima.',
      playFormat: 'Timska igra 4v4 sa prijavljenim transform ulogama, commander-call strukturom i weekly reevaluation pravilima.',
      funTestUse: 'Academy simulation za role trening, rotacije formi i replay učenje bez finansijskog rizika.',
      professionalUse: 'Rank-gated ladder sa 1350 threshold-om, manjim START troškom, audit tragom i postepenim prelazom ka višem profesionalnom sloju.',
    },
    mechanics: [
      {
        title: 'Osnovna pravila i readiness tok',
        points: [
          'Pre svakog Professional meča tim prijavljuje commander-a, četiri transform uloge i readiness status svakog igrača.',
          'Meč se vrednuje kroz ishod, objective tempo, disciplinu formi i to da li su ključne odluke bile održive za 1350 band.',
          'Jedan dobar engage nije dovoljan ako tim zatim izgubi map shape, cooldown prozor ili kontrolu zone.',
        ],
      },
      {
        title: 'Forme i odgovornost',
        points: [
          'Svaki igrač mora imati najmanje dve forme koje može pouzdano da koristi bez rušenja kompozicije.',
          'Commander vodi osnovni makro plan, ali svi članovi moraju poštovati prijavljenu transform ulogu i signal za prebacivanje.',
          'Loša zamena forme ili panična rošada linija obara readiness kvalitet i može ukinuti bonus pravo.',
        ],
      },
      {
        title: 'Objective lanac i tempo',
        points: [
          'TRANSFORMES 1350 nagrađuje čiste sekvence: osvajanje zone, energy node kontrolu, shield break i kontrolisani završni push.',
          'Rani burst bez pretvaranja u map dobitak ima malu operativnu vrednost.',
          'Najstabilniji timovi znaju kada da prepuste malu zonu i sačuvaju form cooldown za sigurniji sledeći objective.',
        ],
      },
      {
        title: 'Review i integritet meča',
        points: [
          'Replay mora potvrditi da commander bonus, role discipline i clean form rotation nisu naknadno ulepšani ili lažno prijavljeni.',
          'Ponavljani laki protivnici, nerealne surrender sekvence ili isto čudno preklapanje formi aktiviraju ručni hold.',
          'Weekly reevaluation može vratiti tim u academy simulation zonu ako readiness stabilnost padne ispod praga.',
        ],
      },
    ],
    everythingInGame: [
      {
        title: 'Mapa, zone i objective tačke',
        points: [
          'Energy node-ovi, control ring-ovi i centralni core corridor su glavni checkpointovi readiness kvaliteta.',
          'Tim mora da pokaže da razume kada se mapa sužava, a kada se širi kroz sigurne rotacije i zonski pritisak.',
        ],
      },
      {
        title: 'Forme, uloge i kompozicija',
        points: [
          'Prioritet imaju forme koje podržavaju jasan engage, reposition i objective plan umesto samo solo highlight potencijala.',
          'Kompozicija treba da pokaže da tim razume sopstveni ceiling, a ne da kopira viši skill sloj bez osnove.',
        ],
      },
      {
        title: 'Readiness score i ladder pravila',
        points: [
          '1350 readiness score spaja performans signale, replay kvalitet, role pouzdanost i anti-abuse istoriju.',
          'Timovi sa nedovoljno stabilnim score-om ostaju u training ili low-risk prozorima dok ne poprave disciplinu.',
        ],
      },
      {
        title: 'Weekly ciklus i academy sloj',
        points: [
          'Academy simulation sesije služe za testiranje novih formi, rotacija i commander-call obrazaca bez novčanog rizika.',
          'Samo verified ladder formati ulaze u payout i bounty evidenciju.',
        ],
      },
    ],
    tacticalGuide: [
      {
        title: 'Opening taktike',
        focus: 'Prva transform rotacija',
        points: [
          'Prvi minuti služe da tim pokaže da razume bezbedno preuzimanje zone i redosled formi.',
          'Greška u opening-u nije samo energy minus već signal da ekipa ne kontroliše osnovni ritam partije.',
        ],
      },
      {
        title: 'Mid-game taktike',
        focus: 'Prvi objective lanac',
        points: [
          'Posle prve prednosti cilj je energy node ili shield break, ne nepotrebno produžavanje borbe.',
          'Commander mora brzo da odluči da li se prednost ulaže u core pressure, reset resursa ili drugu stranu mape.',
        ],
      },
      {
        title: 'End-game taktike',
        focus: 'Disciplina završnice',
        points: [
          'Na ovom nivou partije se najčešće gube zbog prenagljenog push-a bez sačuvanih mobility formi i zone kontrole.',
          'Clean finish znači da tim zna kada da uspori i zatvori partiju kroz dve kontrolisane sekvence umesto jednog kockarskog ulaza.',
        ],
      },
      {
        title: 'Kontrolni stil',
        focus: 'Tempo i prostor',
        points: [
          'Kontrolni stil je najzdraviji za 1350 band jer smanjuje broj haotičnih odluka i povećava verovatnoću clean review-a.',
          'Zonska disciplina i uredan redosled formi troše vreme protivniku i čuvaju sopstveni readiness signal.',
        ],
      },
      {
        title: 'Kontra jačima',
        focus: 'Strukturisan otpor',
        points: [
          'Protiv jačih timova ne pokušavaj da imitiraš njihov tempo bez resursa; prisili ih na sporiji meč i više odluka pod kontrolom prostora.',
          'Jedan dobar counter-transform i siguran zone trade vrede više od očajničkog full-commit engage-a.',
        ],
      },
    ],
    explainedTopics: [
      {
        title: '1350 readiness score',
        what: 'Minimalni profesionalni prag koji kombinuje performance signal, replay kvalitet, širinu formi i fair-play stabilnost.',
        why: 'Odvaja igrače spremne za novac od onih koji još uvek pripadaju academy simulation okruženju.',
        whenToUse: 'Kao ulazni filter pre svakog ozbiljnog ladder prozora i weekly reevaluacije.',
        whenNotToUse: 'Ne sme se tumačiti kao trajna titula ili garancija da je igrač spreman za viši competitive nivo.',
        whatItBrings: 'Fer ulaz, manji finansijski rizik i jasniji razvojni put.',
        cost: 'Traži stalno održavanje kvaliteta, replay pregled i disciplinu formi.',
        misuseConsequence: 'Ako se prag ignoriše ili olabavi, ceo academy ladder gubi smisao i postaje laka meta za abuse.',
        impact: 'Menja ko ulazi u Professional sesije, kako se timovi formiraju i koliko su payout odluke pouzdane.',
      },
      {
        title: 'Commander chain',
        what: 'Sekvenca od najmanje tri povezane timske odluke koje jasno prate prijavljeni transform plan.',
        why: 'Pokazuje da pobeda nije slučajan snowball već rezultat koordinacije i razumevanja tempa.',
        whenToUse: 'Kod pripreme objective prozora, rotacija formi i prelaska iz zone plusa u map kontrolu.',
        whenNotToUse: 'Ne treba ga prijavljivati za svaki nasumični clash bez jasne veze sa planom.',
        whatItBrings: 'Viši kvalitet review-a i pravo na commander discipline bonus.',
        cost: 'Traži doslednu komunikaciju i replay koji može da potvrdi nameru i izvršenje.',
        misuseConsequence: 'Lažno prijavljen chain vodi bonus hold-u i ruši poverenje u timski status.',
        impact: 'Direktno utiče na payout, reputaciju commander-a i readiness kontinuitet ekipe.',
      },
      {
        title: 'Weekly reevaluation',
        what: 'Periodična provera da li tim i dalje ispunjava 1350 prag kroz nove mečeve, role signale i anti-abuse čistoću.',
        ...
        whenNotToUse: 'Ne sme se koristiti kao kazna bez dokaza; traži jasan replay i metrikama potkrepljen razlog.',
        whatItBrings: 'Stabilniji ladder, manje collusion prostora i zdraviji razvojni tok ka višem nivou.',
        cost: 'Može usporiti payout i tražiti dodatne academy simulation korekcije.',
        misuseConsequence: 'Površna reevaluacija ili preterana strogoća kažnjava legitimne timove i ruši angažman.',
        impact: 'Određuje ko zadržava pristup novčanom ladder-u i ko mora nazad u trening režim.',
      },
    ],
    economyBreakdown: [
      { title: 'Trajna licenca', value: '13.500 RSD', detail: 'Otključava TRANSFORMES 1350 professional academy ladder pristup.' },
      { title: 'START kredit', value: '1.350 RSD po igraču', detail: 'Manji finansijski prag za prvi verified transformacioni novčani sloj.' },
      { title: 'Ulazni trošak', value: '10.800 RSD timski zbir', detail: '8 igrača rezerviše sredstva pre zaključavanja meča.' },
      { title: 'Nagradni fond', value: '54.000 RSD', detail: 'Bazni fond za verified pobednički tim u academy ladder formatu.' },
      { title: 'Bonus logika', value: '13.500 RSD', detail: 'Commander-chain, objective chain i form discipline bonusi traže pobedu i clean review.' },
      { title: 'Rezervisana sredstva', value: 'Review hold + operator reserve', detail: 'Pokrivaju replay analizu, sporove i anti-collusion provere.' },
      { title: 'Isplate', value: 'Weekly verified settlement', detail: 'Release ide po zatvaranju dispute i reevaluation prozora.' },
      { title: 'Penali', value: 'Readiness pad / collusion hold / role breach', detail: 'Mogu vratiti tim u academy simulation ili ukinuti bonus i payout pravo.' },
      { title: 'Primer obračuna', value: '10.800 entry → 54.000 payout + bonus', detail: 'Tim prolazi commander review, čistu objective sekvencu i nedeljni audit bez zastavice.' },
    ],
    scenarios: [
      {
        title: 'Meč od prijave do isplate',
        summary: 'Licenca, readiness potvrda, 4v4 ladder, review i weekly settlement.',
        steps: ['Kupovina licence', '1350 gate potvrda', 'START hold i zaključavanje uloga', 'Verified ladder meč', 'Replay + payout release'],
      },
      {
        title: 'Pobeda bez bonusa',
        summary: 'Tim igra čisto i stabilno, ali bez posebne commander-chain ili objective sekvence.',
        steps: ['Mirna otvaranja zona', 'Siguran objective trade', 'Kontrolisan završni push', 'Verified win', 'Bazni payout'],
      },
      {
        title: 'Pobeda sa bonusima',
        summary: 'Pobeda uključuje jasan commander-chain i clean form rotation.',
        steps: ['Kompozicija sa jasnim planom', 'Zona priprema', 'Tri povezana timska poteza', 'Win potvrđen', 'Bonus ide kroz review pa settlement'],
      },
      {
        title: 'Pad ispod 1350 praga',
        summary: 'Tim dobija meč, ali reevaluation pokazuje lošu disciplinu i sumnjive obrasce.',
      ...
      {
        title: 'Prelazak ka višem programu',
        summary: 'Stabilan TRANSFORMES 1350 tim koristi academy ladder kao stepenik ka većem profesionalnom sloju.',
        steps: ['Više clean weekly ciklusa', 'Stabilna širina formi', 'Bez collusion zastavica', 'Preporuka za viši fond i teži bracket'],
      },
    ],
    metaDevelopment: [
      { title: 'Trenutno najjače', detail: 'Jasne 4v4 kompozicije sa stabilnim control formama i sigurnim objective tranzicijama.' },
      { title: 'Stabilno za razvoj', detail: 'Kompozicije koje praštaju manji positioning minus i i dalje održavaju objective plan.' },
      { title: 'Visok skill signal', detail: 'Tim koji dobija bez haotičnog chain-swap-a i zadržava disciplinu prostora kroz celu završnicu.' },
      { title: 'Šta menja balans', detail: 'Patch koji pojača mobility burst, shield uptime ili objective vrednost direktno menja readiness prag.' },
      { title: 'Uticaj weekly review-a', detail: 'Striktniji review podiže kvalitet timova, ali i kažnjava one koji ne održavaju širinu formi.' },
    ],
    learningPath: [
      {
        level: 'Početnik',
        mustUnderstand: ['Osnovne forme i raspodelu uloga', 'Zašto burst nije važniji od zone i objective-a'],
        mustPractice: ['Mirne rotacije', 'Jednostavne support transform sekvence'],
        eliminateMistakes: ['Jurenje bez prostora', 'Ignorisanje cooldown odgovora'],
      },
      {
        level: 'Srednji nivo',
        mustUnderstand: ['Kako prvi dobitak postaje objective', 'Šta commander zapravo traži od tima'],
        mustPractice: ['Rotacije formi', 'Pravovremeno povlačenje posle uzetog cilja'],
        eliminateMistakes: ['Prazan clash posle dobitka', 'Nejasne role zamene'],
      },
      {
        level: 'Napredni nivo',
        mustUnderstand: ['Cooldown i reset plan', 'Kako replay review čita discipline signale'],
        mustPractice: ['Kontrolu prostora', 'Više formi bez rušenja kvaliteta'],
        eliminateMistakes: ['Pohlepni završni ulaz', 'Neprijavljen ili haotičan commander plan'],
      },
      {
        level: 'Profesionalni nivo',
        mustUnderstand: ['1350 gate, weekly reevaluation i payout tok', 'Kako timska disciplina utiče na finansijski ishod'],
        mustPractice: ['Čistu komunikaciju', 'Verified objective sekvence', 'Stabilnost kroz više nedelja'],
        eliminateMistakes: ['Collusion signale', 'Pad širine formi', 'Ignorisanje review povratnih informacija'],
      },
    ],
    glossary: [
      { term: '1350 readiness', category: 'Access', definition: 'Ulazni profesionalni prag koji meri stabilnost, širinu formi, replay kvalitet i fair-play signal.' },
      { term: 'Academy simulation', category: 'Gameplay', definition: 'Fun/Test okruženje za trening kompozicija, komunikacije i rotacija bez novca.' },
      { term: 'Commander chain', category: 'Gameplay', definition: 'Više uzastopnih timskih odluka koje potvrđuju da tim svesno prati jedan makro plan.' },
      { term: 'Form discipline', category: 'Rang', definition: 'Dosledno korišćenje prijavljene transform uloge bez rušenja timske strukture i readiness kvaliteta.' },
      { term: 'Weekly reevaluation', category: 'Admin', definition: 'Periodična provera da li tim i dalje zaslužuje 1350 professional status.' },
      { term: 'Ladder hold', category: 'Finansije', definition: 'Privremeno zadržavanje payout-a i statusa dok traje replay ili anti-collusion pregled.' },
    ],
    faq: [
      { question: 'Šta je zapravo TRANSFORMES 1350?', answer: 'To je manji profesionalni transformacioni ladder sloj za timove koji su prošli 1350 readiness gate, ali još nisu u najvišem competitive programu.' },
      { question: 'Koliko košta jedan meč?', answer: '1.350 RSD START po igraču uz prethodno kupljenu trajnu licencu.' },
      { question: 'Da li je 1350 samo broj?', answer: 'Ne; predstavlja kombinaciju performance signala, replay kvaliteta, širine formi i weekly discipline.' },
      { question: 'Kako ulazim u Professional mečeve?', answer: 'Kroz tri transform discipline provere, clean replay review i aktivnu 18+ / ID verifikaciju.' },
      { question: 'Zašto je payout na hold-u?', answer: 'Najčešće zbog commander-chain review-a, sumnjivog pairinga, role breach-a ili pada ispod readiness praga.' },
    ],
    trust: [
      { title: 'Provera readiness-a', detail: 'Ne gleda se samo pobeda već i da li tim deluje održivo, disciplinovano i bez sumnjivih obrazaca.' },
      { title: 'Replay i žalbe', detail: 'Svaki spor oko bonus-a, commander-chain-a ili discipline formi može da ide na ručni pregled.' },
      { title: 'Detekcija abuse-a', detail: 'Sistem prati prečeste iste protivnike, čudne surrender tokove, lažne uloge i collusion signale.' },
      { title: 'Audit trag', detail: 'Readiness score promene, bonus odluke i weekly status ostavljaju dokumentovan razlog i ishod.' },
      { title: 'Kontinuirana kompetentnost', detail: 'Professional pristup ostaje aktivan samo dok tim održava 1350 prag kroz više ciklusa.' },
    ],
    relatedSections: [
      ...
      { label: 'Lifecycle', anchor: 'match-lifecycle', note: 'Koraci od prijave uloga do replay zaključka.' },
      { label: 'Compliance', anchor: 'compliance-controls', note: 'ID, anti-collusion i replay review pravila.' },
      { label: 'Playground', anchor: 'fun-test-playground', note: 'Academy simulation i role trening bez novca.' },
    ],
    continuousTestingGate: {
      title: 'TRANSFORMES 1350 Readiness Gate',
      summary: 'Ulazak u TRANSFORMES 1350 professional ladder traži dokaz da tim i svaki igrač mogu stabilno da održe 1350 readiness prag kroz transform testove, replay proveru i nedeljnu reevaluaciju.',
      goals: [
        'Sprečiti da jedan lucky win ili solo-carry iluzija otključa pristup novčanom ladder-u bez stvarne discipline.',
        'Održati Professional pristup kao privilegiju zasnovanu na ponovljivim clean mečevima.',
        'Jasno odvojiti academy simulation učenje od verified competitive statusa.',
      ],
      qualificationMetrics: [
        { title: 'Readiness threshold', value: '1350 minimum', detail: 'Svaki igrač i tim moraju održati score iznad 1350 da bi ostali u Professional prozoru.' },
        { title: 'Transform coverage', value: '2+ forme', detail: 'Svaki igrač mora pokazati najmanje dve pouzdane forme bez pada discipline.' },
        { title: 'Commander compliance', value: '>= 80%', detail: 'Tim mora pratiti prijavljene makro pozive kroz većinu ključnih sekvenci.' },
        { title: 'Critical abuse flags', value: '0 critical', detail: 'Kritični collusion i lažni telemetry signali automatski ruše pristup.' },
        { title: 'Retention check', value: 'Nedeljno', detail: 'Status se održava samo uz kontinuirano prolazne rezultate.' },
      ],
      knowledgeCategories: [
        { title: 'Transform strategija', points: ['Kada menjati formu zbog prostora, ne samo zbog štete.', 'Kako čuvati mobility i control sekvence za pravi objective prozor.'] },
        { title: 'Mapa i objective ritam', points: ['Energy node i shield lane prioriteti moraju pratiti plan tima.', 'Jedan osvojen prostor mora voditi sledećem sigurnom cilju.'] },
        { title: 'Commander i komunikacija', points: ['Call mora biti jasan, proverljiv i dosledno izvršen.', 'Nasumična samostalna prebacivanja ruše readiness signal.'] },
        { title: 'Integrity i anti-abuse', points: ['Svaka anomalija u telemetry, surrender-u ili pairingu utiče na payout.', 'Readiness ostaje validan samo dok je signal čist kroz više ciklusa.'] },
      ],
      visualQuestionRules: [
        'Vizuelni zadaci koriste map segmente, form swap sekvence i objective rasporede za procenu odluka.',
        'Kandidat mora objasniti zašto je određena forma pravilna u datom trenutku, ne samo koji je ishod borbe.',
        'Scenario varijacije se rotiraju da bi se sprečilo mehaničko pamćenje odgovora.',
      ],
      weeklyCycle: [
        { title: 'Ponedeljak', summary: 'Otvaranje ciklusa i postavljanje pragova.', steps: ['Ažuriranje readiness watchliste', 'Objava fokus scenarija', 'Reset pairinga za academy grupu'] },
        { title: 'Utorak–sreda', summary: 'Standardne readiness sesije.', steps: ['Transform evaluacije', 'Merenje discipline formi', 'Praćenje commander compliance-a'] },
        { title: 'Četvrtak', summary: 'Replay i anomaly analiza.', steps: ['Pregled sumnjivih sekvenci', 'Detekcija lažnih call-chain obrazaca', 'Privremeni hold spornih naloga'] },
        { title: 'Petak', summary: 'Professional ladder window.', steps: ['Verified mečevi', 'Payout pre-scoring', 'Prioritet anomalija i dispute check'] },
        { title: 'Subota', summary: 'Manual review i korekcije.', steps: ['Ručni pregled spornih replay-eva', 'Korekcija statusa', 'Ažuriranje retention odluka'] },
        { title: 'Nedelja', summary: 'Settlement i go/no-go evaluacija.', steps: ['Zaključavanje nedelje', 'SLA pregled sporova', 'Objava statusa za sledeći ciklus'] },
      ],
      retentionRules: [
        'Pad ispod readiness praga u dva uzastopna ciklusa vraća tim u academy simulation ili low-risk režim.',
        'Svaki critical anti-collusion signal automatski suspenduje Professional isplate do konačne odluke.',
        'Ponovni ulazak nakon suspenzije zahteva nov čist kvalifikacioni ciklus.',
      ],
      antiAbuseRules: [
        'Lažni commander-chain, namešten pairing i sumnjivo sinhrono prebacivanje formi pokreću trenutni review hold.',
        'Multi-account povezivanje u istom prozoru automatski blokira bonus i progression priznanje.',
        'Ponavljani match-krugovi sa istim grupama igrača imaju cooldown pre novih payout priznanja.',
        'Tokom aktivnog review-a nalog ne može preći u verified payout status.',
      ],
      userJourney: [
        'Korisnik kreće od academy simulation sesija i gradi disciplinu bez finansijskog rizika.',
        'Nakon readiness ciklusa prelazi u low-risk Professional ladder window.',
        'Ako održava stabilnost i čist signal, ulazi u weekly competitive i bonus zonu.',
        'Ako padne ispod retention praga, vraća se u trening ili dobija privremenu suspenziju.',
      ],
      successMetrics: [
        'Conversion stopa iz academy simulation u Professional sa održanim statusom.',
        'Procenat clean sesija bez dispute-a i bez manual hold-a.',
        'Broj critical anomaly trigger-a na 1.000 mečeva.',
        'Median vreme od pending do paid statusa.',
        'Koliko timova zadržava 1350 readiness kroz više nedelja bez povratka u academy.',
      ],
      rolloutPhases: [
        'Faza 1: definisanje TRANSFORMES 1350 identiteta, readiness formule i academy simulation sloja.',
        'Faza 2: controlled pilot sa ograničenim brojem verified četvorki i pojačanim review-em.',
        'Faza 3: aktivacija full Professional ladder-a uz stabilne payout i retention pragove.',
        'Faza 4: optimizacija anomaly modela ka nižem false-positive nivou.',
        'Faza 5: proširenje competitive prozora uz očuvanje ekonomskog balansa.',
      ],
    },
  },
  'gejming-industrija': {
    shortOverview: [
      'Gejming industrija je data-driven program na `/games` sa jednim centralnim Gejming endžin konceptom.',
      'Program jasno razdvaja Fun/Test sandbox i Professional režim sa finansijskom odgovornošću.',
      'SPAJAPRO koordiniše module, proverava kompatibilnost i čuva audit trag celog toka igranja.',
    ],
    expandedOverview: [
      'Gejming endžin standardizuje identitet igre, pravila meča, ulaz/izlaz formate i module.',
      'ChatGPT link sloj postoji samo kao validiran knowledge kanal za edukaciju, level dizajn i QA pitanja.',
      'Professional sesije koriste readiness gate, anti-abuse kontrole i nedeljni ciklus verifikacije pre isplate.',
    ],
    expertView: [
    ...
    operationalView: [
      'Fun/Test služi za trening i validaciju bez novca, dok Professional uvodi licencu, START i payout tok.',
      'Svaka Professional partija čuva module mapu, ChatGPT link evidenciju i compatibility score po fazama.',
      'Sporovi, mismatch signali i anti-abuse zastavice drže isplate u hold-u dok se ne zatvori review.',
    ],
    historyMetaScenarios: [
      'Najčešći pad nastaje kada tim kopira taktike bez standardizovanih modula i izgubi konzistentnost ponašanja.',
      'Meta je stabilnija kada su modul klase unapred definisane i kada fallback ima stroga pravila povratka.',
      'Najvredniji scenario razvoja je prelazak iz sandbox testova u Professional sesije bez promene identiteta igre.',
    ],
    masterProfile: {
      identity: 'Gejming industrija',
      genre: 'Gaming engine systems',
      subgenre: 'Modular compatibility skill competition',
      coreIdea: 'Centralni Gejming endžin upravlja modulima i garantuje da ista pravila važe u svakom sloju igranja.',
      matchGoal: 'Pobediti uz čist compatibility trag, stabilan meč identitet i usklađenost svih modula.',
      victoryCondition: 'Verified pobeda sa zatvorenim auditom, clean module sync-om i bez critical abuse signala.',
      audience: 'Igrači i timovi koji žele sistemski, proverljiv i kompatibilan model digitalnog igranja.',
      sessionLength: '20 do 45 minuta po sesiji.',
      entryDifficulty: 'Srednje visoka; traži logiku, konzistentnost i disciplinu rukovanja modulima.',
      tacticalDepth: 'Visoka; svaka odluka utiče na kompatibilnost, scoring i finansijski ishod.',
      playFormat: 'Solo ili timski meč sa standardizovanim modul klasama i lifecycle pravilima.',
      funTestUse: 'Sandbox testiranje pravila, nivoa i modulskih prelaza bez finansijskog rizika.',
      professionalUse: 'Licencirani mečevi sa START uplatom, readiness gate-om, audit logom i payout kontrolama.',
    },
    mechanics: [
      {
        title: 'Cilj i granice režima',
        points: [
          'Fun/Test režim je otvoren za eksperiment i obuku, bez realnog novca i bez payout očekivanja.',
          'Professional režim traži licencu, verifikacije i prolaz kroz readiness kriterijume.',
          'Prelazak između režima ne sme menjati osnovna pravila igre niti scoring model.',
        ],
      },
      {
        title: 'Gejming endžin pravila',
        points: [
          'Svaka sesija koristi isti engine schema ID, isti meč lifecycle i iste ulaz/izlaz formate.',
          'Endžin validira module pre starta i blokira meč ako nedostaje obavezna kompatibilnost.',
          'Audit log pamti odluke, fallback događaje i finalni status kompatibilnosti.',
        ],
      },
      {
        title: 'ChatGPT link disciplina',
        points: [
          'Dozvoljeni su samo validirani linkovi za edukaciju, dizajn nivoa i QA scenarije.',
          'Svaki link mora biti vezan za konkretnu sesiju i kategoriju upotrebe.',
          'Neregistrovani ili nevalidirani link ulazi u review i može suspendovati Professional rezultat.',
        ],
      },
      {
        title: 'SPAJAPRO orkestracija',
        points: [
          'SPAJAPRO vodi sesiju kroz intake, module check, start, live telemetry, settlement i post-review.',
          'Ako modul padne, aktivira se fallback bez promene identiteta i meč pravila.',
          'Fallback mora završiti sa jasnim razlogom, rollback tragom i statusom kompatibilnosti.',
        ],
      },
    ],
    everythingInGame: [
      ...
      {
        title: 'ChatGPT link i QA sloj',
        points: [
          'Linkovi se koriste kao pomoć za teoriju, validaciju level plana i proveru pitanja/odgovora.',
          'Sistem čuva ko je koristio link, zašto i u kom koraku lifecycle-a.',
        ],
      },
    ],
    tacticalGuide: [
      ...
      {
        title: 'Mid-game taktike',
        focus: 'SPAJAPRO orchestration discipline',
        points: [
          'U sredini meča fokus je na stabilnom telemetry tragu i doslednom ponašanju modula.',
          'Ako dođe do devijacije, aktiviraj fallback brzo i dokumentuj razlog bez menjanja scoring pravila.',
        ],
      },
      {
        title: 'End-game taktike',
        focus: 'Settlement readiness',
        points: [
          'Pred završnicu proveri da su svi ChatGPT link unosi, QA odgovori i module eventi zaključani.',
          'Clean završnica znači da payout može odmah u verified status bez dodatnog ručnog hold-a.',
        ],
      },
    ],
    explainedTopics: [
      {
        title: 'Gejming endžin',
        what: 'Centralni programski sloj koji standardizuje pravila, formate i lifecycle svih sesija.',
        why: 'Bez jednog endžina sistem brzo gubi konzistentnost i pravi konflikte između modula.',
        whenToUse: 'U svakoj sesiji kao obavezni osnovni sloj pre bilo kakvog Professional starta.',
        whenNotToUse: 'Ne treba praviti paralelna pravila van endžina jer to ruši kompatibilnost.',
        whatItBrings: 'Predvidljiv gameplay, lakši audit i stabilniji prelaz između režima.',
        cost: 'Traži disciplinu modelovanja i redovne compatibility provere.',
        misuseConsequence: 'Nedovoljna standardizacija vodi sporovima, mismatch-u i payout blokadama.',
        impact: 'Direktno menja kvalitet igranja, fairness i poverenje u finansijski tok.',
      },
      {
        title: 'ChatGPT link sloj',
        what: 'Bezbedan i validiran skup ChatGPT referenci vezan za edukaciju, dizajn nivoa i QA.',
        why: 'Omogućava pomoć bez ugrožavanja integriteta meča i bez nekontrolisanih izvora.',
        whenToUse: 'Tokom pripreme sadržaja, obuke i verifikacije pitanja pre ili posle meča.',
        whenNotToUse: 'Ne koristi se za neauditirane prečice, skrivena pravila ili manipulisanje scoring logikom.',
        whatItBrings: 'Brže učenje, jasnije QA procese i transparentan trag izvora znanja.',
        cost: 'Traži validaciju linkova i dosledno beleženje u audit log.',
        misuseConsequence: 'Nevalidirani linkovi ruše trusted status sesije i otvaraju review hold.',
        impact: 'Poboljšava kvalitet sadržaja uz očuvanje bezbednosti i usklađenosti.',
      },
      {
        title: 'SPAJAPRO orkestracija',
        what: 'Operativni okvir za lifecycle sesije, kompatibilnost modula i fallback kontrolu.',
        why: 'Drži ceo sistem organizovanim i sprečava nekontrolisane prelaze između slojeva.',
        whenToUse: 'U svim sesijama gde postoji više modula i potreba za verifikovanim settlement-om.',
        whenNotToUse: 'Ne preskače se ni u kratkim mečevima jer time nestaje audit kontinuitet.',
        whatItBrings: 'Ujednačene procese, manje grešaka i brže rešavanje sporova.',
        cost: 'Zahteva strogo poštovanje lifecycle koraka i pravila fallback-a.',
        misuseConsequence: 'Ad-hoc orkestracija pravi neusklađenost i može invalidirati Professional rezultat.',
        impact: 'Povećava stabilnost, transparentnost i kompatibilnost čitavog game programa.',
      },
    ],
    economyBreakdown: [
    ...
    scenarios: [
      {
        title: 'Od sandboxa do Professionala',
        summary: 'Igrač trenira u Fun/Test režimu, prolazi gate i prelazi na licencirani meč.',
        steps: ['Sandbox test', 'Readiness provera', 'Kupovina licence', 'Professional START', 'Verified settlement'],
      },
      {
      ...
      },
      {
        ...
        summary: 'Jedan modul pada, SPAJAPRO aktivira fallback i meč ostaje validan.',
        steps: ['Detekcija greške', 'Fallback aktivacija', 'Rollback log', 'Nastavak meča', 'Review potvrda'],
      },
      {
        title: 'ChatGPT link spor',
        summary: 'Korišćen je link bez validacije i sesija ide u hold.',
        steps: ['Audit zastavica', 'Ručna provera izvora', 'Korekcija evidencije', 'Odluka o statusu', 'Settlement ili suspenzija'],
      },
    ],
    metaDevelopment: [
      { title: 'Trenutno najjače', detail: 'Timovi koji unapred zaključavaju modul parove i igraju sa stabilnim lifecycle disciplinama.' },
      { title: 'Stabilno za razvoj', detail: 'Sandbox-first pristup sa postepenim prelazom i jasnim readiness pragovima.' },
      { title: 'Visok skill signal', detail: 'Pobede koje ostaju kompatibilne kroz više sesija bez fallback konflikta.' },
      { title: 'Šta menja balans', detail: 'Promene u module klasama ili previše labava ChatGPT link politika.' },
      { title: 'Uticaj review-a', detail: 'Striktniji review smanjuje abuse i povećava kvalitet Professional sesija.' },
    ],
    learningPath: [
      {
        level: 'Početnik',
        mustUnderstand: ['Razliku između Fun/Test i Professional režima', 'Osnovni smisao centralnog Gejming endžina'],
        mustPractice: ['Sandbox sesije', 'Osnovni modul lock i check'],
        eliminateMistakes: ['Preskakanje compatibility provere', 'Mešanje režimskih pravila'],
      },
      {
        level: 'Srednji nivo',
        mustUnderstand: ['Kako SPAJAPRO vodi lifecycle', 'Kako radi cross-check između slojeva'],
        mustPractice: ['Stabilan module pairing', 'Dokumentovanje fallback događaja'],
        eliminateMistakes: ['Kasna reakcija na mismatch', 'Nejasni QA tragovi'],
      },
      {
        level: 'Napredni nivo',
        mustUnderstand: ['ChatGPT link audit pravila', 'Kako compatibility score utiče na payout'],
        mustPractice: ['Konzistentan input/output format', 'Incident response bez promene pravila'],
        eliminateMistakes: ['Nevalidirani linkovi', 'Ad-hoc izmene scoring logike'],
      },
      {
        level: 'Profesionalni nivo',
        mustUnderstand: ['Readiness gate, retention i weekly settlement tok', 'Self-compatibility kao uslov poverenja'],
        mustPractice: ['Čist audit trail', 'Ponovljive kompatibilne pobede kroz više ciklusa'],
        eliminateMistakes: ['Critical abuse signale', 'Nekonzistentan engine schema', 'Nedokumentovan fallback'],
      },
    ],
    glossary: [
    ...
    faq: [
      { question: 'Šta je Gejming industrija program?', answer: 'To je `/games` program zasnovan na centralnom Gejming endžinu i modulskom modelu kompatibilnosti.' },
      { question: 'Kako se deli Fun/Test i Professional režim?', answer: 'Fun/Test je sandbox bez novca, a Professional traži licencu, verifikacije, START i readiness prolaz.' },
      { question: 'Čemu služe ChatGPT linkovi?', answer: 'Samo za validirane edukativne, dizajn i QA reference koje imaju audit evidenciju.' },
      { question: 'Šta radi SPAJAPRO?', answer: 'Organizuje lifecycle sesije, proverava module i aktivira fallback bez narušavanja identiteta igre.' },
      { question: 'Šta ako modul nije kompatibilan?', answer: 'Sistem blokira ili stavlja sesiju u review hold dok se ne zatvore mismatch i audit koraci.' },
    ],
    trust: [
    ...
    continuousTestingGate: {
      ...
      summary: 'Ulazak i ostanak u Professional režimu zahteva dokaz da Gejming endžin, ChatGPT link sloj i SPAJAPRO orkestracija rade kompatibilno i bez abuse signala.',
      goals: [
        'Očuvati jedinstven identitet igre kroz sve module i sesije.',
        'Sprečiti da nevalidirani linkovi ili neusklađeni moduli utiču na rezultat.',
        'Držati Professional isplate vezane za ponovljive clean compatibility tokove.',
      ],
      qualificationMetrics: [
      ...
      visualQuestionRules: [
        'Vizuelna pitanja proveravaju da li igrač prepoznaje kompatibilan modul par i ispravan lifecycle korak.',
        'Odgovor mora sadržati razlog izbora, ne samo konačan ishod.',
        'Scenariji se rotiraju da bi se sprečilo šablonsko pamćenje i lažna prolaznost.',
      ],
      weeklyCycle: [
        { title: 'Ponedeljak', summary: 'Otvaranje nedeljnog ciklusa.', steps: ['Reset watchliste', 'Objava fokus modula', 'Plan sandbox testova'] },
        { title: 'Utorak–sreda', summary: 'Readiness i compatibility sesije.', steps: ['Module check', 'Engine lock validacija', 'ChatGPT link evidencija'] },
        { title: 'Četvrtak', summary: 'Anomaly i fallback analiza.', steps: ['Pregled mismatch signala', 'Fallback review', 'Privremeni hold spornih naloga'] },
        { title: 'Petak', summary: 'Professional match window.', steps: ['Verified mečevi', 'Pre-settlement scoring', 'Dispute pre-check'] },
        { title: 'Subota', summary: 'Manual review i korekcije.', steps: ['Ručna provera spornih sesija', 'Korekcija statusa', 'Retention odluke'] },
        { title: 'Nedelja', summary: 'Settlement i objava statusa.', steps: ['Zatvaranje audit ciklusa', 'Isplate clean sesija', 'Go/no-go za sledeću nedelju'] },
      ],
      retentionRules: [
        'Dva uzastopna ciklusa sa padom compatibility skora vraćaju korisnika u Fun/Test sandbox.',
        'Svaki critical abuse signal automatski suspenduje Professional isplate do završnog pregleda.',
        'Povratak u Professional zahteva nov kvalifikacioni ciklus i čist audit.',
      ],
      antiAbuseRules: [
      ...
      userJourney: [
        ...
        'Nakon prolaska gate-a prelazi u low-risk Professional sesije sa START uplatom.',
        'Uz stabilan score i čist audit prelazi u pun weekly payout ciklus.',
        'Ako izgubi kompatibilnost ili dobije abuse zastavicu, vraća se u korektivni trening režim.',
      ],
      successMetrics: [
        'Stopa prelaska iz Fun/Test u Professional bez povratka u roku od 30 dana.',
        'Procenat sesija sa clean module sync-om i bez fallback eskalacije.',
        'Broj spornih ChatGPT link događaja na 1.000 sesija.',
        'Median vreme od pending do paid statusa.',
        'Udeo korisnika koji održavaju self-compatibility prag kroz više nedelja.',
      ],
      rolloutPhases: [
        'Faza 1: definicija Gejming endžin standarda i modul klasifikacije.',
        'Faza 2: pilot sa ograničenim brojem Professional sesija i pojačanim review-em.',
        'Faza 3: puna aktivacija readiness gate-a i weekly settlement toka.',
        'Faza 4: optimizacija anti-abuse modela i smanjenje false-positive slučajeva.',
        'Faza 5: skaliranje programa uz očuvanje self-compatibility i audit discipline.',
      ],
    },
  },
};
